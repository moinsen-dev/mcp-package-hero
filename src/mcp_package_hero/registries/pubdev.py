...
class PubDevRegistry(BaseRegistry):
    """Client for pub.dev package registry."""

    def __init__(self, base_url: str = "https://pub.dev/api"):
        """Initialize pub.dev registry client."""
        super().__init__(Ecosystem.DART, base_url)
    ...
    async def get_latest_version(self, package_name: str) -> PackageVersion:
        ...
        Args:
            package_name: Name of the Dart package
